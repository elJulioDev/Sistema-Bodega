            ...
            <div class="card shadow-sm border-0 bg-light">
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <span>$ <input type="text" id="resumenNeto" readonly value="0" class="border-0 bg-transparent text-end fw-medium input-w-100 outline-0" ></span>
                    </div>
                    <div class="d-flex justify-content-between mb-2">
                        <span class="fw-bold text-secondary">IVA (19%):</span>
                        <span>$ <input type="text" id="resumenIva" readonly value="0" class="border-0 bg-transparent text-end fw-medium input-w-100 outline-0" ></span>
                    </div>
                    <hr>
